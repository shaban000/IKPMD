...
public class DatabaseInfo {
    public class databaseTabels{
        ...
        public static final String leerdoel = "Leerdoelen";
    }
    public class Columns {
        public static final String SUBDOEL_NAME = "Naam";
        public static final String LEERDOEL_NAME = "Naam";
        public static final String WEEK = "Week";
        public static final String VOLDAAN = "Voldaan";
